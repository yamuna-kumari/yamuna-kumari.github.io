...
const blogPosts = [
  {
    ...
    excerpt:
      "Learn how to design and implement scalable microservices architecture using Node.js and modern best practices.",
    date: "2024-03-15",
    readTime: "8 min read",
  ...
  },
  {
    ...
    excerpt:
      "Explore essential DevOps practices that help teams deliver software faster and more reliably.",
    date: "2024-03-05",
